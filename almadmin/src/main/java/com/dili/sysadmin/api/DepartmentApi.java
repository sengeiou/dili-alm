...
public class DepartmentApi {
	...
	@RequestMapping(value = "/getChildDepartments", method = { RequestMethod.GET, RequestMethod.POST })
	public BaseOutput<List<Department>> getChildDepartments(@RequestBody Long departmentId) {
		List<Department> list = this.departmentService.getChildDepartments(departmentId);
		return BaseOutput.success().setData(list);
	}
