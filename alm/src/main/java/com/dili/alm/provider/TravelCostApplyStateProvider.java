...
@Component
public class TravelCostApplyStateProvider implements ValueProvider {

	@Override
	public List<ValuePair<?>> getLookupList(Object val, Map metaMap, FieldMeta fieldMeta) {
		List<ValuePair<?>> list = new ArrayList<>(TravelCostApplyState.values().length);
		for (TravelCostApplyState state : TravelCostApplyState.values()) {
