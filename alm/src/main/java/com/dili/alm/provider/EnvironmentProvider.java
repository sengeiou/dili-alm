 ...
 */
@Component
public class EnvironmentProvider implements ValueProvider, ApplicationListener<ContextRefreshedEvent> {
	...
	public List<ValuePair<?>> getLookupList(Object obj, Map metaMap, FieldMeta fieldMeta) {
		...
		AlmCache.ENVIRONMENT_MAP.forEach((k, v) -> {
	...
	public String getDisplayText(Object obj, Map metaMap, FieldMeta fieldMeta) {
		if (obj == null || obj.equals(""))
			return null;
		return AlmCache.ENVIRONMENT_MAP.get(obj.toString());
	}
}