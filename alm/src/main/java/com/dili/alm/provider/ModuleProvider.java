 ...
 */
@Component
public class ModuleProvider implements ValueProvider, ApplicationListener<ContextRefreshedEvent> {
	...
	public List<ValuePair<?>> getLookupList(Object obj, Map metaMap, FieldMeta fieldMeta) {
		...
		AlmCache.LOG_MODULE_MAP.forEach((k, v) -> {
	...
	public String getDisplayText(Object obj, Map metaMap, FieldMeta fieldMeta) {
		if (obj == null || obj.equals(""))
			return null;
		return AlmCache.LOG_MODULE_MAP.get(obj.toString());
	}
}