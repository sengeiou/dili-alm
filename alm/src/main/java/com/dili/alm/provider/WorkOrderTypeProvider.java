 ...
 */
@Component
public class WorkOrderTypeProvider implements ValueProvider {

	@Override
	public List<ValuePair<?>> getLookupList(Object obj, Map metaMap, FieldMeta fieldMeta) {
		Map<String, String> map = AlmCache.getInstance().getWorkOrderTypeMap();
	...
	public String getDisplayText(Object obj, Map metaMap, FieldMeta fieldMeta) {
		if (obj == null || obj.equals(""))
			return null;
		return AlmCache.getInstance().getWorkOrderTypeMap().get(obj.toString());
	}
}