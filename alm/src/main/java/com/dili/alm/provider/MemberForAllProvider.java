 ...
 */
@Component
public class MemberForAllProvider implements ValueProvider {

	@Override
	public List<ValuePair<?>> getLookupList(Object o, Map map, FieldMeta fieldMeta) {
		ArrayList buffer = new ArrayList<ValuePair<?>>();
		AlmCache.getInstance().getUserMap(true).forEach((k, v) -> {
	...
	public String getDisplayText(Object o, Map map, FieldMeta fieldMeta) {
		if (o == null)
			return null;
		User user = AlmCache.getInstance().getUserMap(true).get(Long.parseLong(o.toString()));
