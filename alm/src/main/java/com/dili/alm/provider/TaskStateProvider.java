 ...
 */
@Component
public class TaskStateProvider implements ValueProvider, ApplicationListener<ContextRefreshedEvent> {
	...
	public List<ValuePair<?>> getLookupList(Object obj, Map metaMap, FieldMeta fieldMeta) {
		...
		AlmCache.TASK_STATE_MAP.forEach((k, v) -> {
	...
	public String getDisplayText(Object obj, Map metaMap, FieldMeta fieldMeta) {
		if (obj == null || obj.equals(""))
			return null;
		return AlmCache.TASK_STATE_MAP.get(obj.toString());
	}
}