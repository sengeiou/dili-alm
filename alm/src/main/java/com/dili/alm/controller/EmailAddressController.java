...
public class EmailAddressController {
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "EmailAddress", paramType = "form", value = "EmailAddress的form信息", required = true, dataType = "string") })
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "id", paramType = "form", value = "EmailAddress的主键", required = true, dataType = "long") })
