...
/**
 *  由MyBatis Generator工具自动生成 This file was generated on  2019-12-27 16:48:24.
...
public class MoveLogTableController {
    ...
    @ApiOperation(value="查询MoveLogTable", notes = "查询MoveLogTable返回列表信息")
    @ApiImplicitParams({
    ...
    @ApiOperation(value="分页查询MoveLogTable", notes = "分页查询MoveLogTable返回easyui分页信息")
    @ApiImplicitParams({
		@ApiImplicitParam(name="MoveLogTable", paramType="form", value = "MoveLogTable的form信息", required = false, dataType = "string")
	})
