...
public class ProjectPhaseController {
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "ProjectPhase", paramType = "form", value = "ProjectPhase的form信息", required = false, dataType = "string") })
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "id", paramType = "form", value = "ProjectPhase的主键", required = true, dataType = "long") })
