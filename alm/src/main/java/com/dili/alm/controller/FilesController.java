...
public class FilesController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "Files", paramType = "form", value = "Files的form信息", required = false, dataType = "string") })
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "Files", paramType = "form", value = "Files的form信息", required = true, dataType = "string") })
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "id", paramType = "form", value = "Files的主键", required = true, dataType = "long") })
	...
	@ResponseBody
	public BaseOutput<Object> filesUpload(@RequestParam("file") MultipartFile[] files, HttpServletRequest request, HttpServletResponse response) throws IOException {
		List<Files> uploadFiles = this.filesService.uploadFile(files);
