...
public interface WorkOrderService extends BaseService<WorkOrder, Long> {
	 ...
	 * @throws WorkOrderException
	 */
	void close(Long id, Long operatorId, OperationResult result, String description) throws WorkOrderException;
	...
	void solveAgree(String taskId, Boolean isNeedClaim)  throws WorkOrderException;
	
	void closeAgree(String taskId, Boolean isNeedClaim)  throws WorkOrderException;
	
	void  allocateAgree(Long executorId, String taskId, Boolean isNeedClaim) throws WorkOrderException;
	
	void allocateNotAgree(Long id, Long executorId, String taskId, Boolean isNeedClaim) throws WorkOrderException;
