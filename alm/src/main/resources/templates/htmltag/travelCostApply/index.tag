function addCostItem() {
	...
	$('#travelCostGrid').datagrid('beginEdit', $('#travelCostGrid').datagrid('getRows').length - 1);
}
...
function saveOrUpdate() {
	...
	if (_formData.id == null || _formData.id == "") {
		_url = "${contextPath}/travelCostApply/insert";
	} else {// 有id就修改
		_url = "${contextPath}/travelCostApply/update";
	}
	$.ajax({
				type : "POST",
				url : _url,
